...
export NODE_IMAGE_ORG=${NODE_IMAGE_ORG:-"/var/lib/libvirt/images/${NODE_OS_CODENAME}-server-cloudimg-amd64.img"}
export NODE_IMAGE=${NODE_IMAGE:-"/var/lib/libvirt/images/${NODE_OS_CODENAME}-server-cloudimg-amd64.qcow2"}
